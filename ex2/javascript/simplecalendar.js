	...
	*/
	...
	function Calendar(){
	  ...
	  this.containerLayer.style.zIndex=999;
...
// for side presentation        this.containerLayer.style.left = x+35;
// for side presentation		if (event.y>0)this.containerLayer.style.top = y;

// for underneath presentation
        this.containerLayer.style.left = x-90;
		if (event.y>0)this.containerLayer.style.top = y+22;
	  }
	  if (browser.ns6){
